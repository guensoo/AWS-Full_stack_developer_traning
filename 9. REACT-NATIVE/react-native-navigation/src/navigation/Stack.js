...
const StackNavigation = () => {
  return(
    ...
    <Stack.Navigator initialRouteName="Home" // 첫번째로 띄울 화면을 지정
    // cardStyle을 이용해서 각 화면의 배경색을 설정
      ...
      <Stack.Screen 
          ...
          options={{
            ...
            headerLeft: () => { // 안드로이드에서는 화면 왼쪽에 처리를 하기 위해서는 headerLeft를 써야 한다.
              ...
              return(
                ...
                >
                  <View style={{flexDirection: 'row', alignItems: 'center'}}>
                    <MaterialCommunityIcons name="arrow-left" size={28} color='#e74c3c' />
                    <Text>이전으로</Text>
                  </View>
                </Pressable>
              )
