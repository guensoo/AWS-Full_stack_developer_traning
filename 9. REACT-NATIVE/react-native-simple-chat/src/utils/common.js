...
// ^ : 문자열의 시작
// [0-9?A-z]+ : 0-9, 대문자 A 부터 소문자 z 까지, ? 중 하나 이상 반복
// (\.)? : 마침표가 0번 또는 1번 등장
// @ : @문자
// \. : 마침표
...
export const removeWhitespace = text =>{
  ...
  // text 문자열에서 정규식에 해당하는 부분을 빈 문자열로 바꿔서
  // 공백을 제거하겠다.
}

// [a-z0-9A-Z] : 알파벳 대/소문자, 숫자를 포함한 한글자
// [a-z0-9A-Z]+ : + -> 앞의 패턴이 1번 이상 반복
// ? : 앞의 패턴이 0 or 1번 나타나는 경우와 일치
// {n} : 앞의 패턴이 정확히 n번 나오는 경우와 일치
// {n,m} : 앞의 패턴이 n번에서 m번 사이 만큼 반복